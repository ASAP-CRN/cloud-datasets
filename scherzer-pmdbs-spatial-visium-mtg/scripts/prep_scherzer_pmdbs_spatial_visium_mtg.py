...
intake_doc = (
    ds_path / "refs/Scherzer_visium_Dataset_Information_Template.docx"
...
#########################################################
# INGEST DOI DOCS
setup_DOI_info(ds_path, intake_doc, publication_date="2025-10-30")
...
if False:
    zenodo = setup_zenodo()
    # doi_id = get_doi_from_dataset(ds_path, version=True) #16744324
    doi_id = "17242088"
